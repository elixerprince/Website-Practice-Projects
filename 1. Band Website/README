# I am learning  lot of things while working on this basic project.
    ...
    # I realised that I can use a README file to document stuff I learn along the way which is helpful for myself and others.
    ...
    # Only use the header element when making a page title, section title, or article title. Do not use it for album title etc. Remember that it has semantic meaning. Use a div instead.
